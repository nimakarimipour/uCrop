...
public class BitmapCropTask extends AsyncTask<Void, Void, Throwable> {
    ...
    native public static boolean cropCImg(@Nullable String inputPath, @Nullable String outputPath, int left, int top, int width, int height, float angle, float resizeScale, int format, int quality, int exifDegrees, int exifTranslation) throws IOException, OutOfMemoryError;
