...
public class OverlayView extends View {
    ...
    public OverlayView(Context context, @Nullable AttributeSet attrs, int defStyle) {
     ...
     */
    boolean isFreestyleCropEnabled() {
     ...
     */
    void setFreestyleCropEnabled(boolean freestyleCropEnabled) {
