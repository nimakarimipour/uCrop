...
public class AspectRatioTextView extends AppCompatTextView {
    ...
    public AspectRatioTextView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AspectRatioTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
